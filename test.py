...
.landscape-slice.is-right img {
  transform: translateX(-50%);
}

.landscape-mode-quarter .landscape-slice img {
  width: 200%;
}

.landscape-mode-quarter .landscape-slice.is-top-right img {
  transform: translateX(-50%);
}

.landscape-mode-quarter .landscape-slice.is-bottom-left img {
  transform: translateY(-50%);
}

.landscape-mode-quarter .landscape-slice.is-bottom-right img {
